...
export interface ArticleFeaturedIconProps {
    className?: string
...
const ArticleFeaturedIcon: FC<ArticleFeaturedIconProps> = ({
    className = "",
    ...
    const renderMediaIcon = () => {
        if (headlineTypeName === HeadlineType.SingleVideo) {
            return (
                <svg
                    className={iconSize}
                    viewBox="0 0 24 24"
        ...
        if (headlineTypeName === HeadlineType.SingleAudio) {
            return (
                <svg
                    className={iconSize}
                    viewBox="0 0 24 24"
...
export default ArticleFeaturedIcon
