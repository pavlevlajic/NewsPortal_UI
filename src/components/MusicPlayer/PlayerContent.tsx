    ...
    const renderLeft = () => {
        ...
        return (
            <div className="mr-2 flex items-center flex-grow lg:flex-shrink-0 lg:basis-52 overflow-hidden">
                <Link
                    href={href}
                    className="relative h-14 sm:h-16 flex items-center space-x-2 sm:space-x-3 rtl:space-x-reverse ps-12 overflow-hidden"
                >
                    <NcImage
                        alt={title}
                        fill
        ...
        return (
            ...
            >
                ...
                {playing ? (
                    ...
                    <PlayIcon className="ms-0.5 w-10 h-10 rtl:rotate-180" />
                )}
            </div>
        )
    }
    ...
    const renderForwards15S = () => {
        return (
            ...
            >
                ...
                <svg
                    className="w-6 h-6 block rtl:hidden"
                    viewBox="0 0 24 24"
                    fill="none"
                >
                    <path
