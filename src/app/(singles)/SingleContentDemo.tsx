...
const SingleContentDemo = () => {
    return (
        <>
            ...
            <p>
                It is a long established fact that a <strong>reader</strong>{" "}
                will be distracted by the readable content of a page when
                looking at its <strong>layout</strong>. The point of using Lorem
          ...
          like trash. Make it good then it won't be bad.`}
            ...
            <figure>
                ...
                <figcaption>
                    ...
                    Iure vel officiis ipsum placeat itaque neque dolorem modi
