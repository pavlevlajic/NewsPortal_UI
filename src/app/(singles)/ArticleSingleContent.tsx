...
import ArticleSingleAuthor from "./ArticleSingleAuthor"
import SingleCommentForm from "./SingleCommentForm"
import SingleCommentLists from "./SingleCommentLists"
import SingleContentDemo from "./SingleContentDemo"

interface ArticleSingleContentProps {
    data: Pick<
...
const ArticleSingleContent: FC<ArticleSingleContentProps> = ({ data }) => {
    const {
        htmlContent,
        tags,
        authorFirstName,
    ...
    return (
        <div className="relative">
            <div className="nc-ArticleSingleContent space-y-10">
                {/* ENTRY CONTENT */}
                <div
