...
interface SingleArticleMetaAction2Props {
    className?: string
    meta: Pick<ArticleDetailViewModel, "commentCount" | "reactionCount">
}

const SingleArticleMetaAction2: FC<SingleArticleMetaAction2Props> = ({
    className = "",
    meta,
}) => {
    const { commentCount, reactionCount } = meta

    return (
        <div className={`nc-SingleArticleMetaAction2 ${className}`}>
...
export default SingleArticleMetaAction2
